...
class ProductServiceTest {
        ...
        class GetProductTests {
                ...
                @DisplayName("查詢時若產品 ID 不存在，應拋出 ResourceNotFoundException")
                void getProductDetail_WhenNotFound_ShouldThrowException(String scenario, Integer id) {
                        // Arrange
                        // 修正：增加 String scenario 參數來接收 @CsvSource 的描述文字
        ...
        class DeleteProductTests {
                ...
                @DisplayName("刪除時若產品 ID 不存在，應拋出 ResourceNotFoundException")
                void deleteProduct_WhenIdNotFound_ShouldThrowException(String scenario, Integer id) {
                        // Arrange
                        // 修正：增加 String scenario 參數
                        when(productRepository.findById(id)).thenReturn(Optional.empty());
