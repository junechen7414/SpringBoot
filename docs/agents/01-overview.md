...
這是一個基於 **Spring Boot 4.1.0** 與 **Java 25** 的企業級微服務應用程式，展示現代化的後端開發實踐。專案採用 **Virtual Threads** 提升併發效能，整合 **Oracle Database** 作為主要資料存儲，並透過 **Podman Compose** 實現完整的本地開發與監控環境。

### 核心技術棧

- **框架**: Spring Boot 4.1.0 (WebMVC, RestClient, Data JPA, Validation, AspectJ, Actuator)
