...
*   **application.properties:** 配置應用的行為、屬性。
    *   **常用配置:**
        ...
        *   **Spring Profile Settings：**
            ...
            *   可建立不同的 `application-{profile}.properties` 檔案，例如 `application-dev.properties` 和 `application-prod.properties`，來定義不同 Profile 的配置，預設 application.properties。
...
*   **範例：**[application-dev.properties](demo/src/main/resources/application-dev.properties)